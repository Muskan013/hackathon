...
with st.sidebar:
    ...
    if uploaded_file is not None:
        ...
        st.image(image, caption='Uploaded Heart Disease Risk Factors Report', use_column_width=True)
...
if selected == 'Heart Disease Prediction':
    ...
    with col2:
        sex = st.text_input('Sex (1 = yes; 0 = no)')
    with col3:
    ...
    with col3:
        fbs = st.text_input('Fasting Blood Sugar (fbs)(1 = yes; 0 = no)')
    with col1:
        restecg = st.text_input('Resting Electrocardiographic results(restecg)(1 = yes; 0 = no)')
    with col2:
        thalach = st.text_input('thalach')
    with col3:
        exang = st.text_input('exang (1 = yes; 0 = no)')
    with col1:
        ...
        if valid_hd:
            ...
            if heart_prediction[0] == 1:
                ...
                *Health Recommendations for Heart Disease:*
                ...
                st.write("""
                Regular physical activity is essential for Heart Disease Risk Factor. Below are some recommended exercises:
                """)
                ...
                with col1:
                    st.image("https://www.shape.com/thmb/evTtuA1TPy7CQ_1W19BHpc2AJz8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/step-ups-best-exercises-for-women-fb4bb696dd534d37be4d484785e385ed.jpg", caption="Step-Ups (Using a Low Step)", use_column_width=True)
                    st.write("Mimics the action of stair climbing but at a controlled pace, helping to build leg strength and boost cardiovascular fitness.")
                    
                
                with col2:
                    st.image("https://th.bing.com/th/id/R.2a9b2c707bf7b40d706e9ded1b33246d?rik=CFZxQQQ0gblq6A&riu=http%3a%2f%2fsportsmanslodge.net%2fportals%2f12%2fImages%2fInline-Hiking.jpg&ehk=aVXgJEYyacqbmumVXJ0ugLALS9mVtbSHzvnOBRwH5Pw%3d&risl=&pid=ImgRaw&r=0", caption="Light Hiking", use_column_width=True)
                    st.write("Walking in nature at a slow pace adds mental relaxation and gentle cardiovascular conditioning.")
